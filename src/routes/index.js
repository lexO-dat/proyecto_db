...
const {crearUsuario, cerrarSesion, subirAlien, cambiarNombreUsuario, cambiarCorreo, cambiarTelefono, usuarioConMasComentarios, cambiarContrasena } = require('../controllers/users_controller');
...
router.post('/avistamientos/eliminar-avistamiento', eliminarAvistamiento);
router.post('/avistamientos/cambiar-titulo', cambiarTitulo); //ACAAAA QUEDAMOS
router.post('/avistamientos/cambiar-evidencia', cambiarEvidencia);
router.get('/avistamientos/ultimos-10-avistamientos', ultimos10avistamientos);
router.get('/avistamiento-con-mas-comentarios', avistamientoconmascomentarios);
...
router.post('/admin/pais/crear-pais', crearPais); //check (funciona pero tira error raroto)
...
router.post('/admin/avistamiento/cambiar-clasificacion', cambiarClasificacion);

//ruta de conexion a Comentarios
router.post('/comentarios/crear-comentario', crearComentario);
router.post('/comentarios/eliminar-comentario', eliminarComentario);
router.post('/comentarios/editar-comentario', editarComentario);
